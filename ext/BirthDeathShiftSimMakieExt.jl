module BirthDeathShiftSimMakieExt

import Makie, BirthDeathShiftSim

function BirthDeathShiftSim.treeplot(
    tree::BirthDeathShiftSim.Root
)
    ...
    ## vertical lines
    x, y, states = BirthDeathShiftSim.coordinates_vertical(tree)

    c_states_vertical = Int64[]
    ...
    state_space = unique(values(BirthDeathShiftSim.tipstates(tree)))
